...
class Wallet {
  ...
  factory Wallet.fromJson(Map<String, dynamic> json) {
    ...
    return Wallet(
      valorantPoints:
          (balances['85ad13f7-3d1b-5128-9eb2-7cd8ee0b5741'] as num?)?.toInt() ??
              0,
      radianitePoints:
          (balances['e59aa87c-4cbf-517a-5983-6e81511be9b7'] as num?)?.toInt() ??
              0,
      kingdomCredits:
          (balances['85ca954a-41f2-ce94-9b45-8ca3dd39a00d'] as num?)?.toInt() ??
              0,
      freeAgentCurrency:
          (balances['f08d4ae3-939c-4576-ab26-09ce1f23bb37'] as num?)?.toInt() ??
              0,
    );
  }
